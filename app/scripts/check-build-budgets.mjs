...
const budgets = {
  ...
  // medium diagnostics. Keep the raw ceiling narrow while the 150 kB gzip target
  // and 700 kB total runtime ceiling remain the meaningful delivery constraints.
  javascript: 580_000,
  css: 25_000,
  total: 700_000,
  socialImage: 300_000,
