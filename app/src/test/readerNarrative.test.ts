...
describe('reader battle narrative', () => {
  test('explains the horse-sized mallard regression through scale, access, pressure, and a concrete outcome', () => {
    ...
    expect(story).toMatch(/not a literal count of bodies attacking at once/i)
  ...
  test.each([
    ...
    expect(first.plan.turningPoint.concepts).toContain(first.diagnostics.turningPointConcept)
