...
Line of sight, facing, distance, target mass, terrain, weather, time of day, physiology, senses, channel modifiers and applied counters remain generic fields. Petrification, hypnosis and fear channels receive bounded reductions when the target side has prior knowledge, a defensive position or disciplined group doctrine. No creature ID or display name participates in resolution.
...
- all 16 mythology fixtures execute through the complete adapter;
- declared active/rejected and immunity expectations are enforced;
- informed disciplined defenders reduce gaze-channel contribution;
- inactive per-ability overrides preserve deterministic powers, seed, trial rate, probability, winner and factor ledger;
- deterministic state, channels, factors and ability resolutions are invariant across seed and report depth;
- self-effects never supply counter channels, and fire suppression reports an explicit counter diagnostic;
- physical piercing immunity reduces final opponent power;
- the ordinary elephant-versus-wolves fixture stays within 12 percentage points of model 0.3;
- `10^100` opponents remain finite without individual instantiation;
- the extracted sampling helper leaves the model 0.3 regression suite unchanged.
